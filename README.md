...
@pnodev/sync-cli/0.1.1 linux-x64 node-v20.5.1
...
_See code: [src/commands/generate-types.ts](https://github.com/pnodev/pno-sync-cli/blob/v0.1.1/src/commands/generate-types.ts)_
...
_See code: [src/commands/login.ts](https://github.com/pnodev/pno-sync-cli/blob/v0.1.1/src/commands/login.ts)_
...
_See code: [src/commands/send.ts](https://github.com/pnodev/pno-sync-cli/blob/v0.1.1/src/commands/send.ts)_
<!-- commandsstop -->
